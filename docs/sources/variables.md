...
The [Grafana Crash Course](https://grafana.com/docs/plugins/marcusolsson-static-datasource/<PLUGINS_VERSION>/exploring-variables/) discusses three types of variables.
