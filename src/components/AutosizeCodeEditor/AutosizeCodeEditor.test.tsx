...
/**
 * Inlined from @volkovlabs/components AutosizeCodeEditor.test.tsx
 * (https://github.com/grafana/volkov-packages/blob/main/packages/components/src/components/AutosizeCodeEditor/AutosizeCodeEditor.test.tsx).
 */
